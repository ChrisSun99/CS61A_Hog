...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    FreeBacon = 2 + abs(score // 10 - score % 10)
    return FreeBacon
    # END PROBLEM 2
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            ...
            new_score = take_turn(num_rolls0,score1,dice)
            score0 += new_score
            ...
            new_score = take_turn(num_rolls1,score0,dice)
            score1 += new_score
            swap = is_swap(score0, score1)
            if swap:
                score0, score1 = score1, score0
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    i , highest, highest_dice = 1, 0, 0
    while i <= 10 :
        averaged_dice = make_averaged(roll_dice, num_samples)
        k = averaged_dice(i, dice)
        if k > highest:
            highest, highest_dice = k, i
        i += 1
    return highest_dice
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    # BEGIN PROBLEM 11
    bacon = free_bacon(opponent_score)
    bacon_result = score + bacon
    if margin <= bacon and is_swap(bacon_result, opponent_score) == False:
        return 0
    elif is_swap(bacon_result, opponent_score) == True and bacon_result < opponent_score :
        return 0
    else :
        return num_rolls  # Replace this statement
    # END PROBLEM 11
...
@main
def run(*args):
    """Read in the command-line argument and call corresponding functions.
